<!-- C:\xampp\htdocs\projetweb-test\view\club\create.php -->
<?php if (!isset($_GET['controller']) || !isset($_GET['action'])) {
    header('Location: ../../index.php?controller=club&action=create');
    exit;
} ?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    <div class="container mt-5">
        ...
        <form action="?controller=club&action=store" method="POST" class="needs-validation" novalidate>
            <div class="mb-3">

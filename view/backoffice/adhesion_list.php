                    ...
                    <tbody>
                        <?php foreach ($adhesions as $adhesion): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?controller=backoffice&action=adhesionEdit&id=<?= urlencode($adhesion->getIdAdhesion()) ?>" class="btn btn-primary btn-sm">Modifier</a>
                                    <a href="?controller=adhesion&action=delete&id=<?= urlencode($adhesion->getIdAdhesion()) ?>" 
                                       class="btn btn-danger btn-sm" 
                                       onclick="return confirm('Voulez-vous vraiment supprimer cette adhésion ?');">Supprimer</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>

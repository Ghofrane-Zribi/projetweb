...
<body>
    <?php include 'navbar.php'; ?> <!-- Nouvelle navbar ajoutée -->
                    ...
                    <?php foreach ($admins as $admin): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="?controller=admin&action=delete&id=<?= urlencode($admin->getIdAdmin()) ?>" 
                                   class="btn btn-danger btn-sm" 
                                   onclick="return confirm('Voulez-vous vraiment supprimer cet admin ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>

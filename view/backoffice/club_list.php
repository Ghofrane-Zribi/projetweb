<!-- C:\xampp\htdocs\projetweb-test\view\backoffice\club_list.php -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="?controller=backoffice&action=clubCreate" class="btn btn-success mt-3">Ajouter un club</a>
    </div>

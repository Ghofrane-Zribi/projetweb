<!-- C:\xampp\htdocs\projetweb-test\view\backoffice\etudiant_list.php -->
...
<body>
    ...
    <div class="container mt-5">
                    ...
                    <tbody>
                        <?php foreach ($etudiants as $etudiant): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($etudiant->getCv()) ?></td>
                                <td>
                                    <a href="?controller=backoffice&action=etudiantEdit&id=<?= urlencode($etudiant->getIdEtudiant()) ?>" class="btn btn-primary btn-sm">Modifier</a>
                                    <a href="?controller=backoffice&action=etudiantDelete&id=<?= urlencode($etudiant->getIdEtudiant()) ?>" 
        ...
        <a href="?controller=backoffice&action=etudiantCreate" class="btn btn-success mt-3">Ajouter un étudiant</a>
    </div>

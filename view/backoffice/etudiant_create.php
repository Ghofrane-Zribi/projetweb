<!-- C:\xampp\htdocs\projetweb-test\view\backoffice\etudiant_create.php -->
<?php if (!isset($_GET['controller']) || !isset($_GET['action'])) {
    header('Location: ../../index.php?controller=backoffice&action=etudiantCreate');
    exit;
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="?controller=backoffice&action=etudiantCreate" method="POST" class="needs-validation" novalidate>
            <div class="mb-3">

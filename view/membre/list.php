<!-- C:\xampp\htdocs\projetweb-test\view\membre\list.php -->
...
<body>
    <div class="container mt-5">
                    ...
                    <tbody>
                        <?php foreach ($membres as $membre): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="?controller=membre&action=edit&id=<?= urlencode($membre->getIdMembre()) ?>" class="btn btn-primary btn-sm">Modifier</a>
                                    <a href="?controller=membre&action=delete&id=<?= urlencode($membre->getIdMembre()) ?>" 
        ...
        <a href="?controller=membre&action=create" class="btn btn-success mt-3">Ajouter un membre</a>
        <a href="?controller=admin&action=dashboard" class="btn btn-secondary mt-3">Retour au tableau de bord</a>
    </div>
